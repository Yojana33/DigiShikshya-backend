...
public class StudentEnrollmentRepository : IStudentEnrollmentRepository
{
    ...
    {
        var query = @"
            INSERT INTO student_enrollment (id, student_id, batch_id, semester_id, enrolled_date, created_at)
    ...
    {
        var totalCountQuery = "SELECT COUNT(*) FROM student_enrollment";
    ...
    {
        var query = "DELETE FROM student_enrollment WHERE id = @Id";
