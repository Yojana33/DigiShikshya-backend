...
public class AssignmentRepository : IAssignmentRepository
{
    ...
    {
        var query = @"
            INSERT INTO assignment (id, title, description, due_date, subject_id, teacher_id, created_at) 
    ...
    {
        var totalCountQuery = "SELECT COUNT(*) FROM assignment";
        ...
        var query = @"
                ...
                INNER JOIN semester sem ON s.semester_id = sem.id  -- Join with semester table
